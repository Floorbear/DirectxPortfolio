...
void DNFAvatarGUI::OnGUI(GameEngineLevel* _Level, float _DeltaTime)
{
	if (DNFGlobalValue::CurrentLevel != nullptr)
	{
		...
		//무기
		{
			...
			ImGui::BeginChildFrame(static_cast<ImGuiID>(reinterpret_cast<size_t>("WeaponSelect")), { 115 * 2 , 115 * 1 });
		...
		//헤어
		{
			...
			ImGui::BeginChildFrame(static_cast<ImGuiID>(reinterpret_cast<size_t>("HairSelect")), { 115 * 2 , 115 * 1 });
			//일반 헤어
		...
		//모자
		{
			...
			ImGui::BeginChildFrame(static_cast<ImGuiID>(reinterpret_cast<size_t>("CapSelect")), { 115 * 3 , 115 * 1 });
		...
		//상의
		{
			...
			ImGui::BeginChildFrame(static_cast<ImGuiID>(reinterpret_cast<size_t>("CoatSelect")), { 115 * 3 , 115 * 1 });
		...
		//하의
		{
			...
			ImGui::BeginChildFrame(static_cast<ImGuiID>(reinterpret_cast<size_t>("PantsSelect")), { 115 * 2 , 115 * 1 });
		...
		//벨트
		{
			...
			ImGui::BeginChildFrame(static_cast<ImGuiID>(reinterpret_cast<size_t>("BeltSelect")), { 115 * 3 , 115 * 1 });
		...
		//신발
		{
			...
			ImGui::BeginChildFrame(static_cast<ImGuiID>(reinterpret_cast<size_t>("ShoesSelect")), { 115 * 3 , 115 * 1 });
